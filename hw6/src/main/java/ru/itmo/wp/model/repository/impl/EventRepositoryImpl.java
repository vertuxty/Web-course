...
public class EventRepositoryImpl extends BaseRepositoryImpl implements EventRepository {
    public Event toEvent(ResultSetMetaData metaData, ResultSet resultSet) throws SQLException {
        if (!resultSet.next()) {
            return null;
        }
        ...
        for (int i = 1; i <= metaData.getColumnCount(); i++) {
            switch (metaData.getColumnName(i)) {
                ...
                case "userId":
                    ...
                    break;
                case "type":
                    event.setType(Event.types.valueOf(resultSet.getString(i)));
                    break;
                case "creationTime":
    ...
    public void save(Event event) {
        try (Connection connection = DATA_SOURCE.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(
                ...
                statement.setObject(2, event.getType().name());
