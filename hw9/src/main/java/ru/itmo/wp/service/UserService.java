...
public class UserService {
    ...
    public UserService(UserRepository userRepository, RoleRepository roleRepository, PostService postService) {
    ...
    public void writePost(User user, PostCredentials postCredentials) {
        Post post = postService.createPost(postCredentials);
        user.addPost(post);
        post.setUser(user);
        userRepository.save(user);
    }
